...
export default function Ec() {
  ...
  return (
     ...
     <h1 className="left-aligned-heading">Department of Electronics and Communication Engineering</h1>
      <div className="breadcrumb">
        <p>Home / Departments / Department of Electronics and Communication Engineering</p>
      </div>
